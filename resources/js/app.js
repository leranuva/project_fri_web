...
// Exponer analytics globalmente para Alpine.js (Fase 8)
window.trackQuoteCalculated = analytics.trackQuoteCalculated;
window.trackQuoteSaved = analytics.trackQuoteSaved;
window.trackTrackingSearch = analytics.trackTrackingSearch;
window.trackCheckoutClick = analytics.trackCheckoutClick;
window.trackStoreRedirect = analytics.trackStoreRedirect;

// PWA: registrar Service Worker (solo en build de producción)
if (import.meta.env.PROD && import.meta.hot === undefined) {
