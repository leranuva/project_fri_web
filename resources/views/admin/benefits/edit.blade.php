<x-app-layout>
    ...
    <x-ui.container>
        <x-ui.card glassmorphism="true" padding="lg" class="mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs sm:text-sm md:text-base text-white/80 truncate">
                            Modifica la información del beneficio: {{ $benefit->title }}
                        </p>
                    </div>
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        <a href="{{ route('admin.benefits.show', $benefit) }}" class="glass-button glass-button-sm w-full sm:w-auto flex items-center justify-center">
            ...
            <form method="POST" action="{{ route('admin.benefits.update', $benefit) }}" class="space-y-6">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <input 
                            ...
                            id="title_color" 
                            name="title_color" 
                            value="{{ old('title_color', $benefit->title_color ?? '#ffffff') }}"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <input 
                            ...
                            value="{{ old('description_color', $benefit->description_color ?? '#ffffff') }}"
                            class="w-20 h-12 rounded-lg border-2 border-white/30 cursor-pointer"
                            style="background: transparent;"
                ...
                <div>
                    ...
                    >{{ old('icon_svg', $benefit->icon_svg) }}</textarea>
                    ...
                    <div id="icon_preview" class="mt-4 p-4 rounded-xl bg-white/5 border border-white/10">
                        ...
                        <div class="flex items-center justify-center p-4 bg-white/10 rounded-lg">
                            <div id="preview_icon_content">{!! $benefit->icon_svg !!}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-4 border-t border-white/10">
                    <button type="submit" class="glass-button glass-button-sm sm:glass-button w-full sm:w-auto flex items-center justify-center">
                        ...
                        <span class="text-xs sm:text-sm md:text-base">Actualizar Beneficio</span>
                    </button>
