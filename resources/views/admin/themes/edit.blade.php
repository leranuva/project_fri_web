<x-app-layout>
            ...
            <form method="POST" action="{{ route('admin.themes.update', $theme) }}" class="space-y-6">
                ...
                <div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 sm:gap-4">
                                <input 
                                    ...
                                    value="{{ old('background_gradient_start', $theme->background_gradient_start) }}"
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 sm:gap-4">
                                <input 
                                    ...
                                    value="{{ old('background_gradient_mid', $theme->background_gradient_mid) }}"
                                    class="w-12 h-8 sm:w-16 sm:h-10 rounded-lg border-2 border-white/30 cursor-pointer flex-shrink-0"
                                    style="background: transparent;"
                                    onchange="updateGradientPreview()"
                                >
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 sm:gap-4">
                                <input 
                                    ...
                                    value="{{ old('background_gradient_end', $theme->background_gradient_end) }}"
                                    class="w-12 h-8 sm:w-16 sm:h-10 rounded-lg border-2 border-white/30 cursor-pointer flex-shrink-0"
                                    style="background: transparent;"
                                    onchange="updateGradientPreview()"
                                >
                    ...
                    <div class="mt-4 p-4 rounded-xl bg-white/5 border border-white/10">
                        ...
                        <div id="gradient_preview" class="w-full h-20 rounded-lg border-2 border-white/20" style="background: linear-gradient(135deg, {{ old('background_gradient_start', $theme->background_gradient_start) }}, {{ old('background_gradient_mid', $theme->background_gradient_mid) }}, {{ old('background_gradient_end', $theme->background_gradient_end) }});"></div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 sm:gap-4">
                            <input 
                                ...
                                value="{{ old('text_color', $theme->text_color) }}"
                                class="w-16 h-10 sm:w-20 sm:h-12 rounded-lg border-2 border-white/30 cursor-pointer flex-shrink-0"
                                style="background: transparent;"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 sm:gap-4">
                            ...
                            <x-text-input 
                                ...
                                class="auth-form-input flex-1 min-w-0" 
                                value="{{ old('text_secondary_color', $theme->text_secondary_color) }}"
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 pt-4 border-t border-white/10">
                    <button type="submit" class="glass-button glass-button-sm sm:glass-button w-full sm:w-auto flex items-center justify-center min-w-0">
                        ...
                        <span class="text-xs sm:text-sm md:text-base truncate">Actualizar Tema</span>
                    </button>
    ...
    <script>
        ...
        // Función para actualizar el color picker desde el texto (si es hex o rgba)
        ...
        // Inicializar los color pickers con los valores actuales del tema
