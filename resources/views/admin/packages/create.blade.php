        ...
        <x-ui.card glassmorphism="true" padding="lg" class="mb-6">
            <div class="mb-4 sm:mb-6">
                ...
                <p class="text-xs sm:text-sm md:text-base text-white/80">
                    Completa el formulario para crear un nuevo paquete con información de tracking.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.packages.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="in_transit" {{ old('status') == 'in_transit' ? 'selected' : '' }}>En Tránsito</option>
                        <option value="received" {{ old('status') == 'received' ? 'selected' : '' }}>Recibido</option>
                        <option value="in_customs" {{ old('status') == 'in_customs' ? 'selected' : '' }}>En Aduana</option>
