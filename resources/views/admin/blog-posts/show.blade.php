        ...
        <x-ui.card glassmorphism="true" padding="lg" class="mb-6">
            ...
            <div class="space-y-6">
                        ...
                        <x-ui.card glassmorphism="true" class="blog-card">
                            <div class="mb-4 flex flex-col h-full">
                                ...
                                <div class="flex-1 flex flex-col">
                                    ...
                                    <div class="mt-auto">
                                        @if($blogPost->link)
                                            <a href="{{ $blogPost->link }}" class="auth-form-link text-sm font-semibold inline-flex items-center gap-1">
                                                Leer más 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    @endif
                    <div class="sm:col-span-2">
                        <p class="text-white/60 text-sm mb-1">CTA (Botón de tienda)</p>
                        <p class="text-white">
                            {{ ($blogPost->cta_active ?? true) ? 'Activo' : 'Desactivado' }}
                            @if($blogPost->cta_active ?? true)
                                — Texto: "{{ $blogPost->cta_label }}"
                                — Enlace: <a href="{{ $blogPost->cta_url }}" target="_blank" class="text-blue-300 hover:text-blue-200 underline break-all">{{ $blogPost->cta_url }}</a>
                            @endif
                        </p>
                    </div>
