    ...
    <x-ui.container>
        <x-ui.card glassmorphism="true" padding="lg" class="mb-6">
            ...
            <form method="POST" action="{{ route('admin.blog-posts.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                {{-- Imagen Destacada --}}
                <div>
                    <x-input-label :value="__('Imagen Destacada (opcional)')" class="text-white/90 mb-2" />
                    ...
                    <div id="image_url_field" style="display: {{ old('image_source', 'url') === 'url' ? 'block' : 'none' }};">
                        ...
                        />
                        <p class="mt-1 text-xs text-white/60">Ingresa la URL completa de la imagen. Opcional.</p>
                    </div>
                    ...
                    <div id="image_file_field" style="display: {{ old('image_source', 'url') === 'file' ? 'block' : 'none' }};">
                        ...
                        >
                        <p class="mt-1 text-xs text-white/60">Formatos permitidos: JPG, PNG, GIF, WEBP (máx. 5MB). Opcional.</p>
                    </div>
                ...
                <div class="p-4 rounded-xl bg-white/5 border border-white/10">
                    <h3 class="text-lg font-semibold text-white mb-4">CTA (Botón de tienda)</h3>
                    <div class="space-y-4">
                        <div class="auth-form-checkbox">
                            <input 
                                ...
                                name="cta_active" 
                                value="1"
                                {{ old('cta_active', true) ? 'checked' : '' }}
                            >
                            <label for="cta_active" class="text-white/90">
                                Mostrar CTA en este artículo
                            </label>
                        </div>
                        <div>
                            <x-input-label for="cta_text" :value="__('Texto del botón')" class="text-white/90 mb-2" />
                            <x-text-input 
                                id="cta_text" 
                                name="cta_text" 
                                type="text" 
                            ...
                            />
                            <p class="mt-1 text-xs text-white/60">Ej: Ir a la tienda, Comprar ahora</p>
                        </div>
                        <div>
                            <x-input-label for="cta_link" :value="__('URL del enlace')" class="text-white/90 mb-2" />
                            <x-text-input 
                                id="cta_link" 
                                name="cta_link" 
                                type="text" 
                            ...
                            />
                            <p class="mt-1 text-xs text-white/60">Dejar vacío para usar la URL de la tienda por defecto</p>
                        </div>
                    </div>
                    <x-input-error class="mt-2" :messages="$errors->get('cta_active')" />
