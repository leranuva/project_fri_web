        ...
        <x-ui.card glassmorphism="true" padding="lg" class="mb-6">
            <div class="mb-4 sm:mb-6">
                ...
                <p class="text-xs sm:text-sm md:text-base text-white/80">
                    Completa el formulario para crear un nuevo slide en el hero slider.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.sliders.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <input 
                            ...
                            id="subtitle_color" 
                            name="subtitle_color" 
                            value="{{ old('subtitle_color', '#ffffff') }}"
                            class="w-20 h-12 rounded-lg border-2 border-white/30 cursor-pointer"
                            style="background: transparent;"
                        >
                        <x-text-input 
                ...
                <div>
                    ...
                    {{-- Campo File Upload --}}
                    <div id="image_file_field" style="display: {{ old('image_source') === 'file' ? 'block' : 'none' }};">
                        <input 
                            type="file" 
                            id="image_file" 
                            name="image_file" 
                    ...
                    <div id="new_image_preview" class="mt-4" style="display: none;">
                        <p class="text-sm text-white/70 mb-2">Vista previa:</p>
                ...
                <div class="p-4 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <div class="mb-4 flex gap-4">
                        <label class="auth-form-checkbox cursor-pointer">
                            <input type="radio" name="video_source" value="url" id="video_source_url" {{ old('video_source', 'url') === 'url' ? 'checked' : '' }} onchange="toggleVideoSource()">
                            <span class="text-white/90">Usar URL</span>
                        </label>
                        <label class="auth-form-checkbox cursor-pointer">
                            <input type="radio" name="video_source" value="file" id="video_source_file" {{ old('video_source') === 'file' ? 'checked' : '' }} onchange="toggleVideoSource()">
                            <span class="text-white/90">Subir desde PC</span>
                        </label>
                    </div>

                    <div id="video_url_field" style="display: {{ old('video_source', 'url') === 'url' ? 'block' : 'none' }};">
                        <x-text-input id="video_url" name="video_url" type="text" class="auth-form-input" :value="old('video_url')" placeholder="https://www.youtube.com/watch?v=..." />
                        <p class="mt-1 text-xs text-white/60">URL directa (MP4, WebM, OGG) o enlace de YouTube (youtube.com/watch?v=... o youtu.be/...)</p>
                    </div>

                    <div id="video_file_field" style="display: {{ old('video_source') === 'file' ? 'block' : 'none' }};">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-4 border-t border-white/10">
                    <button type="submit" class="glass-button glass-button-sm sm:glass-button w-full sm:w-auto flex items-center justify-center">
                        ...
                        <span class="text-xs sm:text-sm md:text-base">Crear Slide</span>
                    </button>
