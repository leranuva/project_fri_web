<x-guest-layout>
    <div class="min-h-screen flex flex-col" style="padding-top: 0;">
            ...
            <x-ui.container>
                <div class="text-center mb-12">
                    <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-white">
                        {{ optional($processSection)->title ?? '¿CÓMO FUNCIONA FLAT RATE IMPORTS?' }}
                    </h2>
        ...
        {{-- Sección: Tiendas - Siempre visible con fallback --}}
        <section class="py-12 sm:py-16 lg:py-20" style="background: transparent;">
                <x-ui.container>
                    <h2 
                        class="text-3xl sm:text-4xl font-bold text-center mb-4"
                        style="color: {{ optional($storeSection)->title_color ?? '#ffffff' }};"
                    >
                        {{ optional($storeSection)->title ?? 'Tiendas Asociadas' }}
                    </h2>
                    @if($storeSection && $storeSection->subtitle)
                        <p 
                    ...
                    <x-ui.card glassmorphism="true" padding="lg" class="stores-section">
                        ...
                        @if($storeSection && $storeSection->footer_link && $storeSection->footer_link_text)
        ...
        {{-- Sección: Temas de Interés / Blog - Siempre visible con fallback --}}
                ...
                <x-ui.container>
                    <div class="text-center mb-12">
                        <h2 
                            ...
                            style="color: {{ optional($blogSection)->title_color ?? '#ffffff' }};"
                        >
                                ...
                                <div class="mb-4 flex flex-col h-full">
                                    ...
                                    <div class="flex-1 flex flex-col">
                                        ...
                                        <div class="mt-auto space-y-3">
                                            ...
                                            @else
                                                <a href="{{ url('/blog/' . $post->id . '-' . \Illuminate\Support\Str::slug($post->title)) }}" class="auth-form-link text-sm font-semibold inline-flex items-center gap-1">
                                                    Leer más 
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                                    </svg>
                                            ...
                                            @endphp
                                            @if($ctaVisible)
                                            <a href="{{ $ctaUrl }}" target="_blank" rel="noopener" class="{{ $ctaAnimated ? 'blog-cta-button ' : '' }}inline-flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold text-sm w-full justify-center"
                    ...
                    <div class="text-center mt-12">
                        @if($blogSection && $blogSection->footer_text)
                            <p class="text-white/90 text-lg mb-6">
                                {!! nl2br(e($blogSection->footer_text)) !!}
                            </p>
                        @endif
                        @if($blogSection && $blogSection->button_text && $blogSection->button_link)
                            <a 
