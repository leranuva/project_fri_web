...
class ProductController extends BaseAdminController
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->redirectSuccess('Producto creado exitosamente.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return $this->redirectSuccess('Producto actualizado exitosamente.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return $this->redirectSuccess("Producto '{$productName}' eliminado exitosamente.");
    }
}
